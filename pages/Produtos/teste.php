...
$cd_cliente = $_SESSION['cd_produto'];

try {
    $queryUser = "SELECT * FROM tb_produto WHERE cd_produto = ?";
    $stmtUser = $pdo->prepare($queryUser);
    $stmtUser->execute([$cd_produto]);
    ...
    $queryProducts = "SELECT * FROM tb_produto WHERE cd_produto = ?";
    $stmtProducts = $pdo->prepare($queryProducts);
    $stmtProducts->execute([$cd_produto]);
